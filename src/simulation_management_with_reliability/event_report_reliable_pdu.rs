...
impl Pdu for EventReportReliablePdu {
        ...
        Self: Sized,
    {
        ...
        if pdu_header.pdu_type == PduType::EventReportReliable {
            ...
            return Ok(EventReportReliablePdu {
                pdu_header,
...
mod tests {
    ...
    fn create_header() {
        ...
        assert_eq!(
            ...
            event_report_reliable_pdu.pdu_header.protocol_version
        );
        assert_eq!(
            pdu_header.exercise_id,
            event_report_reliable_pdu.pdu_header.exercise_id
        );
        assert_eq!(
            pdu_header.pdu_type,
            event_report_reliable_pdu.pdu_header.pdu_type
        );
        assert_eq!(
            pdu_header.protocol_family,
            event_report_reliable_pdu.pdu_header.protocol_family
        );
        assert_eq!(
            pdu_header.length,
    ...
    fn deserialize_header() {
        ...
        let new_event_report_reliable_pdu = EventReportReliablePdu::deserialize(buffer).unwrap();
        assert_eq!(
            new_event_report_reliable_pdu.pdu_header,
            event_report_reliable_pdu.pdu_header
        );
    }
}
