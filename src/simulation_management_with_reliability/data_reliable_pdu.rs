...
impl Pdu for DataReliablePdu {
        ...
        Self: Sized,
    {
        ...
        if header.pdu_type != PduType::DataReliable {
            return Err(DISError::invalid_header(
                format!("Expected PDU type DataReliable, got {:?}", header.pdu_type),
                None,
            ));
        }
...
impl DataReliablePdu {
    ...
    /// # Examples
    ///
    /// Initializing an `DataReliablePdu`:
    /// ```
    /// use open_dis_rust::simulation_management_with_reliability::DataReliablePdu;
    /// let pdu = DataReliablePdu::new();
    /// ```
    ///
    pub fn new() -> Self {
        let mut pdu = Self::default();
        pdu.pdu_header.pdu_type = PduType::DataReliable;
...
mod tests {
    ...
    fn serialize_then_deserialize() {
        ...
        let new_pdu = DataReliablePdu::deserialize(&mut deserialize_buf).unwrap();
