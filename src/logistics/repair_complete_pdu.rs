...
impl Pdu for RepairCompletePdu {
        ...
        Self: Sized,
    {
        ...
        if header.pdu_type != PduType::RepairComplete {
...
impl RepairCompletePdu {
    ...
    /// # Examples
    ///
    /// Initializing an `RepairCompletePdu`:
    /// ```
    /// use open_dis_rust::logistics::RepairCompletePdu;
    /// let pdu = RepairCompletePdu::new();
    /// ```
    ///
    pub fn new() -> Self {
        let mut pdu = Self::default();
        pdu.pdu_header.pdu_type = PduType::RepairComplete;
