...
impl Pdu for ResupplyCancelPdu {
        ...
        Self: Sized,
    {
        ...
        if header.pdu_type != PduType::ResupplyCancel {
...
impl ResupplyCancelPdu {
    ...
    /// # Examples
    ///
    /// Initializing an `ResupplyCancelPdu`:
    /// ```
    /// use open_dis_rust::logistics::ResupplyCancelPdu;
    /// let pdu = ResupplyCancelPdu::new();
    /// ```
    ///
    pub fn new() -> Self {
        let mut pdu = Self::default();
        pdu.pdu_header.pdu_type = PduType::ResupplyCancel;
